...
export default function App() {
  ...
  {
    name:"Saravanan",
    img:"https://www2.deloitte.com/content/dam/Deloitte/nl/Images/promo_images/deloitte-nl-cm-digital-human-promo.jpg"
  }]
  return (
    <div className="App">
    {user.map((usr)=>(
    <Demo name={usr.name} img={usr.img}/>
  ))}
    </div>
  );
}

function Demo({img,name}) {
  return (
    <div className="display">
      <img class="user-pic" src={img} alt={name} />
      <p>
        Hello, <b><i>{name}</i></b>🎉🎉
      </p>
    </div>
